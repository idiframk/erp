...
<body class="sidebar-mini layout-fixed vsc-initialized text-sm" data-panel-auto-height-mode="height">
    ...
    <div class="wrapper">
        ...
        <!-- Navbar -->
        <nav
            class="main-header navbar navbar-expand dropdown-legacy border-bottom-0 text-sm navbar-dark navbar-primary">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
                <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                        <a class="dropdown-item" href="#" id="edit_senha"><i class="fas fa-lock mr-2"></i> Alterar
                            Senha</a>
                        <div id="modal_editPass" class="modal fade" data-backdrop="static" tabindex="-1"
                            role="document"></div>
