                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="cnpj" class="form-control text-uppercase"
                                                id="cpfcnpj" onkeyup="somenteNumeros(this);"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            <label class="col-form-label">Número: <span
                                                    class="text-danger">*</span></label>

                                            <input type="text" name="numero" rows="3"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            <label class="col-form-label">Bairro: <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="bairro" rows="3"
                                                class="form-control text-uppercase"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="cform-group col-md-6">
                                            <label class="col-form-label">Contato: <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="contato" rows="3"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table width="100%">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td align="center"><span id="foto_referencia_produto"></span>
                                                        </td>
                                                    </tr>
                                                    <tr>
