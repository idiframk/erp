                            ...
                            <div class="col-12">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input class="form-control text-uppercase" name="dimensao"
                                            placeholder="Insira as dimensões do Produto/Material" type="text" required
                                            maxlength="15" style="border: solid 0.5px #000; width: 200px;"
...
function moeda(a, e, r, t) {
    ...
    if (l += n, 0 == (u = l.length) && (a.value = ""), 1 == u && (a.value = "0" + r + "0" + l), 2 == u && (a.value =
            "0" + r + l), u > 2) {
        for (ajd2 = "",
            j = 0,
            h = u - 3; h >= 0; h--)
