            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Total de OFF's Criadas:</span>
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Total de aço (kg):</span>
                            <span class="info-box-number">900.152,00</span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="card card-success collapsed-card">
                        <div class="card-header">
                            <h3 class="card-title">Previsão de Consumo de Aço por OFF's (Kg)</h3>
...
<!-- ChartJS -->
<script src="<?php echo INCLUDE_PATH_PAGES; ?>plugins/chart.js/Chart.min.js"></script>
<script>
$(function() {
    /* ChartJS
     * -------
