                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <select name="grup_name" class="form-control select2" style="width: 85%;"
                                                ...
                                                <option data-select2-id="57">PLUGUE ELETRICO</option>
                                                <option data-select2-id="58">LUMINARIA
                                                </option>
                                                <option data-select2-id="59">ARGAMASSA
                                                </option>
                                                <option data-select2-id="61">FILTRO</option>
