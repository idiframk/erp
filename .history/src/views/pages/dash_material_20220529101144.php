    ...
    <section class="content-header">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Dashboard de Produtos/Materias</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="home">Home</a></li>
                            <li class="breadcrumb-item active">Dashboard de Materiais</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
...
$(function() {
    ...
    var areaChartData = {
        labels: ['jan/22', 'fev/22', 'mar/22', 'abr/22', 'mai/22', 'jun/22', 'jul/22', 'ago/22',
        ...
        datasets: [{
            ...
            },
            {
                ...
                data: [65, 59, 80, 81, 56, 55, 40, 25, 65, 59, 80, 81]
            },
