                            ...
                            <div class="col-8">
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <label class="col-sm-3 col-form-label" for="formGroupExampleInput">Nome da
                                            Obra:<span class="text-danger">*</span></label></label>
                                        <input type="text" name="nome_obra" id="titulo_aplicacao"
                                            class="form-control text-uppercase" class="form-control"
                                            id="formGroupExampleInput" placeholder="Insira o nome da obra">
                                        ...
                                        <div style="text-align:center" class="image_area">
                                            <form method="post">
                                                <label for="upload_image">
                                                    <img width="150px" src="imagens/produto_sem_foto.jpg"
