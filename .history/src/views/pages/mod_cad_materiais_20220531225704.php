                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-8">
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="form-group" data-select2-id="55">
                                            ...
                                            <select class="form-control select2bs4 select2-hidden-accessible"
                                                ...
                                                <option data-select2-id="57">Alaska</option>
                                                <option data-select2-id="58">California</option>
                                                <option data-select2-id="59">Delaware</option>
                                                <option data-select2-id="60">Tennessee</option>
                                                <option data-select2-id="61">Texas</option>
                                                <option data-select2-id="62">Washington</option>
                                            </select><span
                                                class="select2 select2-container select2-container--bootstrap4 select2-container--above select2-container--focus"
                                                dir="ltr" data-select2-id="18" style="width: 100%;"><span
                                                    class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-wy52-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-wy52-container" role="textbox"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-9">
                                        <label class="col-form-label">Endereço: <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-2">
                                        <label class="col-form-label">UF/Estado: <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <label class="col-sm-3 col-form-label" for="formGroupExampleInput">Nome do
                                            Cliente:<span class="text-danger">*</span></label></label>
