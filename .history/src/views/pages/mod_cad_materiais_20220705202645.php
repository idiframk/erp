                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <input type="text" name="ref_fornecedor" rows="3" class="form-control text-uppercase"
                            ...
                            <div class="form-group col-md-10">
                                <label class="col-form-label">Observação de uso o algo relevante: <span
                                        class="text-danger">*</span></label>
                                <textarea type="text" name="obs_material" rows="3" class="form-control text-uppercase"
