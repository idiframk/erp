                                ...
                                <div class="col-12">
                                    <div class="bg-white border rounded-5">
                                        ...
                                        <div class="p-4 text-center border-top mobile-hidden">
                                            <a class="btn btn-link px-12" data-mdb-toggle="collapse" href="#example3"
                                                ...
                                                <span class="d-none d-md-inline-block">
                                                    ...
                                                    <p>Uma empresa inovadora e comprometida com a satisfação total de
                                                        seus
                                                        clientes
                                                        . Contamos com parceiros e equipes de profissionais altamente
                                                        treinados
                                                        e
                                                        qualificados, aptos para um mercado cada vez mais exigente
                                                        referente a
                                                    ...
                                                    <p>Seriedade, respeito, honestidade e confiança são os valores
                                                        fundamentais
                                                        para
                                                        a SULTEC, visando sempre excelente relacionamento entre
                                                        clientes,
                                                        parceiros
                                                        e empresa.</p>

                                                    <p>Suprir as necessidades de nossos clientes, zelando pela
                                                        qualidade,
                                                        satisfação
                                                        e conforto, alcançando assim nosso objetivo : O reconhecimento e
                                                        crescimento
                                                        de uma empresa modelo na área de impermeabilização e recuperação
                                                        estrutural.
                                                    </p>
                                                </span>
                                            </a>
